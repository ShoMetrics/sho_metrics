...
export function PluginSettingsTab({ settings, onSettingsChange }: PluginSettingsTabProps): React.JSX.Element {
    const updateRootSetting = (key: "overrideWidgetAppearance", value: SettingValue): void => {
        onSettingsChange(normalizePluginGlobalSettings({
            ...settings,
            [key]: value,
        }));
    };
    const updateAppearanceSetting = (key: string, value: SettingValue): void => {
        onSettingsChange(normalizePluginGlobalSettings({
            ...settings,
            appearanceDefaults: {
    ...
    const updateNetworkSetting = (key: string, value: SettingValue): void => {
        onSettingsChange(normalizePluginGlobalSettings({
            ...settings,
            networkDefaults: {
    ...
    const updateDiskThroughputSetting = (key: string, value: SettingValue): void => {
        onSettingsChange(normalizePluginGlobalSettings({
            ...settings,
