...
const HORIZONTAL_GUIDE_LINE_OPACITY = 1;
const ADAPTIVE_GUIDE_STEADY_OPACITY = 0.75;
const ADAPTIVE_GUIDE_ACTIVE_OPACITY = 0.32;
const VERTICAL_GUIDE_LINE_OPACITY = 1;
const ADAPTIVE_VERTICAL_GUIDE_STEADY_OPACITY = 0.75;
