...
describe("settings enum maps", () => {
    const bidirectionalMapCases = [
        ...
        ["memory usage display mode", memoryUsageDisplayModeByProto, storedMemoryUsageDisplayModeByResolved],
        ["GPU VRAM display mode", gpuVramDisplayModeByProto, storedGpuVramDisplayModeByResolved],
