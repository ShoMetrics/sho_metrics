...
export function buildWidgetDataFixture(options: Partial<WidgetData> = {}): WidgetData {
    return {
        ...
        valueQualifierText: options.valueQualifierText,
        valueQualifierIconFragment: options.valueQualifierIconFragment,
        titleCardCaptionText: options.titleCardCaptionText,
